...
<head>
	...
	<title>AMC Inventory Management System</title>
			...
			<div class="col-md-4">
				<div class="card mx-auto">
				  ...
				  <div class="card-body">
				    ...
				    <p class="card-text"><i class="fa fa-user">&nbsp;</i>ML Mathema </p>
			...
			<div class="col-md-8">
				<div class="jumbotron" style="width:100%;height:100%;">
					...
					<div class="row">
						...
						<div class="card">
						      <div class="card-body">
						        <h4 class="card-title">Hello sir?</h4>
						        <p class="card-text">Lui deal bi</p>
						      </div>
						    </div>
